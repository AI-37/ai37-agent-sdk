...
- TypeScript (Node ≥ 22), npm, tsup (пакет `@ai37/agent-sdk`, текущая версия `0.1.0-alpha.23`).
- Python (≥ 3.11), poetry, ruff, mypy, pytest (пакет `ai37-agent-sdk`, текущая версия `0.1.0a15`).
