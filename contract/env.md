...
Замороженный контракт. Используется агентами, оркестратором, billing-microservice.

## Auth (JWKS)
```
AI37_OIDC_ISSUER      # https://auth.dev.sp-ai.ru/application/o/sp-ai/
AI37_OIDC_JWKS_URL    # https://auth.dev.sp-ai.ru/application/o/sp-ai/jwks/
AI37_OIDC_AUDIENCE    # sp-ai-web
...
## Billing
```
BILLING_MICROSERVICE_BASE_URL        # http(s)://billing-microservice...
...
LITELLM_KEY_SOURCE                   # runtime-state | message (миграция; откуда брать litellm_key)
```
