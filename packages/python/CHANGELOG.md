...
- Python API versioned AI37 Agent Card routing-extension:
  `build_agent_routing_extension`, `parse_agent_routing_extension` и
  `normalize_agent_routing_profile`.
- Общий с TypeScript контракт `domains` / `intents` / `excludes` и URI
