...
def test_overrides():
    state = fixtures.runtime_state.active(remaining_total_tokens=42, litellm_key="sk-z")
    assert state.remaining_total_tokens == 42
    assert state.litellm_key == "sk-z"
