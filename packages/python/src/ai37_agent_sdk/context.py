...
class AgentContext:
    ...
    @property
    def litellm_key(self) -> str | None:
        """litellm_key продукта из последнего preflight (или None)."""
        return self._cached_state.litellm_key if self._cached_state else None
