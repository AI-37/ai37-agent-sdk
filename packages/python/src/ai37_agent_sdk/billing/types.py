...
# Wire-формат billing-microservice — camelCase; на стороне Python — snake_case (from_api маппит).
...
class BillingRuntimeState:
    ...
    stale: bool = False
    litellm_key: str | None = None  # секрет — не логировать
    ...
    def from_api(cls, data: dict[str, Any]) -> BillingRuntimeState:
        ...
        return cls(
            ...
            litellm_key=data.get("litellmKey"),
